...
mass_reco_histograms_base = {
    ...
    **count_hist(name="nLeptons", coll="LeptonGood", bins=3,  start=0,  stop=3),
    ...
    "Massreco_chosen_pair_higgs_mass_4": HistConf([
     ...
     "Max_weight_Higgs_vs_Mass_ttH" : HistConf(
            [
                Axis(coll="events", field="max_weight_higgs_mass", pos=None, bins=30, start=0, stop=300,
                  label="Max Weight Higgs Mass [GeV]", overflow=True, underflow=True),
               
                    
                Axis(coll="events", field="max_weight_ttH_mass", pos=None, 
                     bins=30, start=100, stop=1000,
                     label="Mass ttH [GeV]", overflow=True, underflow=True
