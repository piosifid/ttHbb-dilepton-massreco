...
mass_reco_histograms_truth = {
    ...
    "matched_response_jec": HistConf([
        Axis(coll="MatchedJets", field="response_jec", bins=40, start=0.0, stop=2.0,
             label=r"Matched response (JEC)")
    ]),
    "matched_response_regressed": HistConf([
        Axis(coll="MatchedJets", field="response_regressed", bins=40, start=0.0, stop=2.0,
             label=r"Matched response (Regressed)")
    ]),
    "matched_recojet_pt": HistConf([
        Axis(coll="MatchedJets", field="pt", bins=50, start=0, stop=500,
             label=r"Matched reco jet $p_T$ [GeV]")
    ]),
    "matched_genparton_pt": HistConf([
        Axis(coll="MatchedJets", field="genparton_pt", bins=50, start=0, stop=500,
             label=r"Matched parton $p_T$ [GeV]")
    ]),
