...
class ttHbb_Run3(ttHbbBaseProcessor):
    ...
    def __init__(self, cfg) -> None:
        ...
        # NOTE: the era-dependent btag algorithm (self.btag_branch) is NOT
        # resolved here anymore -- see define_common_variables_after_presel
        # for why (it has to be per-chunk, not once per job).
